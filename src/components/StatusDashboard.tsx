  ...
  return (
    <section className="bg-[#0c326f] py-14 px-6 md:px-10 text-center font-sans">
      <div className="max-w-[1215px] mx-auto">
        ...
        <button className="inline-flex items-center justify-center px-6 py-2.5 rounded-full border border-white text-white text-sm font-semibold hover:bg-white/10 transition-colors">
          Mais Indicadores
        </button>
